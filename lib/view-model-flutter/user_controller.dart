...
Future<void> verify() async {
  String uriString = "https://39b9-103-50-129-83.ngrok-free.app/user/verify";
...
Future<List<Map<String, dynamic>>> getUsers() async {
  ...
  final request = Uri.parse(
      'https://39b9-103-50-129-83.ngrok-free.app/user/list/$id_cabangs');
...
Future<int> loginbtn(String email, String pass) async {
  try {
    String uriString = "https://39b9-103-50-129-83.ngrok-free.app/user/login";
    Uri uri = Uri.parse(uriString);
...
void tambahOwner(String email, String pass, String fname, String lname) async {
  try {
    ...
    if (email != "" && pass != "" && fname != "" && lname != "") {
      final url = 'https://39b9-103-50-129-83.ngrok-free.app/user/addOwner';
      final response = await http.post(
        Uri.parse(url),
        headers: {
...
void tambahpegawai(
  ...
  try {
    ...
    if (email != "" && pass != "" && fname != "" && lname != "") {
      final url =
          'https://39b9-103-50-129-83.ngrok-free.app/user/addUser/$id_cabang';
      final response = await http.post(
        Uri.parse(url),
        headers: {
          'Content-Type': 'application/json',
...
void deleteuser(String id, BuildContext context) async {
  ...
  String id_cabang = dataStorage.read('id_cabang');
  final url =
      'https://39b9-103-50-129-83.ngrok-free.app/user/deleteuser/$id/$id_cabang';
...
void UpdateUser(String fname, String lname, String role, String id,
  ...
  String id_cabang = dataStorage.read('id_cabang');
  final url =
      'https://39b9-103-50-129-83.ngrok-free.app/user/updateuser/$id/$id_cabang';
  try {
